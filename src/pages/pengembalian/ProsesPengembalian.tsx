...
export function ProsesPengembalian({ onNavigate }: { onNavigate: (page: string) => void }) {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      await processPengembalian(activePeminjaman.id, user.id, kondisi === "Tidak Lengkap" ? "RUSAK" : "BAIK");
