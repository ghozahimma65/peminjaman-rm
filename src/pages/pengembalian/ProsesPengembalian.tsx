...
export function ProsesPengembalian({ onNavigate }: { onNavigate: (page: string) => void }) {
  ...
  const statusLabel = activePeminjaman?.status === "DIKEMBALIKAN" ? "Dikembalikan" : activePeminjaman?.status === "TERLAMBAT" ? "Terlambat" : "Dipinjam";
